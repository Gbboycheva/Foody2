...
namespace Floody
{
    ...
    public class FoodyTests
    {
        ...
        { 
          var requset = new RestRequest($"/api/Food/Delete/{createdFoodId}", Method.Delete);
          var response = client.Execute(requset);
        ...
        public void EditNonExistingFood_ShouldReturnNotFound()
        {
            ...
            var changes = new[]
            {
                new { path = "/name", op = "replace", values = "New Title"}
            };
        ...
        public void DeleteNonExistingFood_ShouldReturnBadRequest()
        {
            ...
            var requset = new RestRequest($"/api/Food/Delete/{fakeID}", Method.Delete);
            var response = client.Execute(requset);
